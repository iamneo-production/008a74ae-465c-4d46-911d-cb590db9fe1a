...
export default function Editcourse(){
    return(
        ...
        <div style={{width:'80%', backgroundColor:'whitesmoke', padding:'20px 10px'}}>
            <div style={{fontSize:'22px', fontWeight:'bold', padding:'20px'}}>Edit Course</div>
        ...
        <div style={{width:'100%'}}>
            <button className="btn" style={{border:'none', borderRadius:'20px', padding:'10px 25px', backgroundColor:'green', color:'white', cursor:'pointer', margin:'20px', fontSize:'20px'}}>Update Course</button>
        </div>
        </div>
        </div>
    )
